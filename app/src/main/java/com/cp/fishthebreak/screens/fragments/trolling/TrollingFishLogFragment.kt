...
import com.cp.fishthebreak.adapters.trolling.TrollingFishLogAdapter
import com.cp.fishthebreak.databinding.FragmentTrollingFishLogBinding
...
import com.cp.fishthebreak.viewModels.trolling.TrollingFishLogViewModel
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.flow.distinctUntilChanged
import kotlinx.coroutines.launch

@AndroidEntryPoint
class TrollingFishLogFragment : Fragment() {
    private lateinit var binding: FragmentTrollingFishLogBinding
    val viewModel: TrollingFishLogViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        binding = FragmentTrollingFishLogBinding.inflate(layoutInflater,container,false)
        initDataBinding()
        initViewModelResponse()
        return binding.root
    }
    private fun initDataBinding() {
        binding.lifecycleOwner = this@TrollingFishLogFragment
        binding.viewModel = viewModel
        val mLayoutManager = LinearLayoutManager(requireContext())
        binding.rv.layoutManager = mLayoutManager
        binding.locationAdapter = TrollingFishLogAdapter(listOf(), viewModel)
