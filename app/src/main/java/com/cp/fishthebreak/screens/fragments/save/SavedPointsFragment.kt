...
import com.cp.fishthebreak.databinding.FragmentSavedPointsBinding
...
@AndroidEntryPoint
class SavedPointsFragment : Fragment() {

    private lateinit var binding: FragmentSavedPointsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSavedPointsBinding.inflate(layoutInflater, container, false)
        initDataBinding()
    ...
    private fun initDataBinding() {
        binding.lifecycleOwner = this@SavedPointsFragment
        binding.viewModel = viewModel
        val mLayoutManager = LinearLayoutManager(requireContext())
        binding.rv.layoutManager = mLayoutManager
        binding.locationAdapter = SavedLocationAdapter(listOf(), viewModel)
