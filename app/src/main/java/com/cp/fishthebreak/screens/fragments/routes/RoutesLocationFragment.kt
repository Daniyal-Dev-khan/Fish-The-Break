...
import com.cp.fishthebreak.adapters.routes.RouteLocationAdapter
import com.cp.fishthebreak.databinding.FragmentRoutesLocationBinding
...
@AndroidEntryPoint
class RoutesLocationFragment : Fragment() {

    private lateinit var binding: FragmentRoutesLocationBinding
    val viewModel: RoutesLocationViewModel by activityViewModels()
    ...
    override fun onCreateView(
        ...
        binding = FragmentRoutesLocationBinding.inflate(layoutInflater,container,false)
        initDataBinding()
    ...
    private fun initDataBinding() {
        binding.lifecycleOwner = this@RoutesLocationFragment
        binding.viewModel = viewModel
        val mLayoutManager = LinearLayoutManager(requireContext())
        binding.rv.layoutManager = mLayoutManager
        binding.locationAdapter = RouteLocationAdapter(listOf(), viewModel)
